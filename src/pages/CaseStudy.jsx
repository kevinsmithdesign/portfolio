  ...
  return (
    <Container>
      ...
      <Typography mb={3}>
        ...
        support when managing the complex needs of their patients. Communication
        gaps between caregivers and healthcare professionals can lead to delays
        in care, misunderstandings, and increased stress. <br />
        ...
        leaving them feeling unsupported in critical moments. This lack of an
        intuitive, conversational platform makes it harder to address patients
        concerns efficiently and confidently.
      </Typography>
      <Box sx={{ pl: 6 }}>
        <Typography variant="h5" fontWeight="bold">
          “How might we create a platform that empowers caregivers with timely,
          empathetic guidance tailored to their unique challenges?”
        </Typography>
      </Box>
      <CaseStudyDivider />
      <CaseStudyTitle
      ...
      <Typography mb={3}>
        To truly understand the challenges caregivers face, I conducted a series
        of interviews with healthcare professionals and family caregivers,
        focusing on their experiences with communication tools and pain points
        in caregiving support. <br />
        <br /> In addition, I analyzed existing tools in the healthcare and
        caregiver support space. My goal was to identify gaps where Lila could
        offer a more intuitive and empathetic approach, addressing the specific
        needs of caregivers that are often overlooked by current solutions.
      </Typography>
      <Box sx={{ pl: 6, mb: 3 }}>
        <Typography variant="h5" fontWeight="bold">
          “According to recent studies, caregivers feel an increase in stress
          and burnout when unable to access timely information and support.”
        </Typography>
      </Box>
      <Typography mb={3}>
        This insight validated our approach of creating a conversational
        platform that’s accessible 24/7, meeting caregivers’ needs in real-time.
        While many apps provide support during office hours, Lila aims to be a
        constant companion, ready to assist whenever needed.
      </Typography>
      <Typography variant="h6" mb={2} fontWeight="bold">
        Affinity Mapping
      </Typography>
      ...
      <Typography mb={3}>
        ...
        analysis revealed gaps in the current market, particularly in the areas
        of real-time assistance, empathy-driven interactions, and personalized
        guidance. By identifying where competitors fall short, I ensured that
        Lila would address unmet needs and provide a unique, value-driven
        experience tailored to caregivers.
      </Typography>
...
>
  ...
  <Box sx={{ 
    ...
    {competitiveAnalysis.map(
      ({ feature, carely, caringBridge, helpingHands, honor, lila }, index) => (
        <Box sx={{ display: "flex" }} key={feature}>
          <Box
            sx={{
              ...
              borderBottom: "1px solid #DFE4F3",
              borderLeft: "1px solid #DFE4F3",
              borderBottomLeftRadius: index === competitiveAnalysis.length - 1 ? '16px' : 0,
            }}
          >
          ...
          <Box
            sx={{
              ...
              borderLeft: "1px solid #DFE4F3",
              borderRight: "1px solid #DFE4F3",
              borderBottomRightRadius: index === competitiveAnalysis.length - 1 ? '16px' : 0,
            }}
          >
...
>
  ...
  <Box sx={{ 
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Typography fontWeight="bold">Linda (Family Caregiver)</Typography>
      </Box>
      <Box
        sx={{
          flex: {
      ...
      >
        <Typography fontWeight="bold">John (Healthcare Professional)</Typography>
      </Box>
      <Box
        sx={{
          flex: {
      ...
      >
        <Typography fontWeight="bold">Mike (Care Facility Manager)</Typography>
      </Box>
    </Box>
      ...
      <Box sx={{ display: "flex" }} key={journey.stage}>
        <Box
          sx={{
            ...
            borderBottom: "1px solid #DFE4F3",
            borderLeft: "1px solid #DFE4F3",
            borderBottomLeftRadius: index === userJourneys.length - 1 ? '16px' : 0,
          }}
        >
        ...
        <Box
          sx={{
            ...
            borderLeft: "1px solid #DFE4F3",
            borderRight: "1px solid #DFE4F3",
            borderBottomRightRadius: index === userJourneys.length - 1 ? '16px' : 0,
          }}
        >
